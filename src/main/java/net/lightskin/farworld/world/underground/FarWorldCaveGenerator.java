...
public class FarWorldCaveGenerator implements IFlexHandlerStructureGenerator {
    //=============================================
     ...
     */
    public static final int MAX_INIT_NODES = 14;

    /**
     * 1 in LARGE_NODE_RARITY initial attempts will result in large node
     */
    public static final int LARGE_NODE_RARITY = 4;
     ...
     */
    public static final int LARGE_NODE_MAX_BRANCHES = 4;
     ...
     */
    public static final double CAVE_SIZE_ADD = 1.5D;
