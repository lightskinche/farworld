package net.lightskin.farworld.world.underground.generators.arena;
...
public class ArenaRavineGenerator implements IFlexHandlerStructureGenerator{
	  /**
     * Vanilla value: 50
     * <p>
     * Multiply by 16 and divide by 8: 16 cubes in vanilla chunks, only one in 8 cubes has structures generated
     */
    private static final int RAVINE_RARITY = 500 * 16 / (2 * 2 * 2);
     ...
     */
    private static final double LAVA_HEIGHT_OFFSET = -20;
    ...
    public ArenaRavineGenerator(CustomGeneratorSettings cfg) {
