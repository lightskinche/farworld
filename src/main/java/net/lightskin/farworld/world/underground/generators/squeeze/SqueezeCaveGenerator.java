...
public class SqueezeCaveGenerator implements IFlexHandlerStructureGenerator {
    //=============================================
     ...
     */
    public static final int LARGE_NODE_MAX_BRANCHES = 50;
     ...
     */
    public static final double CAVE_SIZE_ADD = 0.25D;
