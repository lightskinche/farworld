package net.lightskin.farworld.world.underground.layers.tmp;
...
public class CavernLayer extends Layer{

	public CavernLayer(int begin_in, int length_in) {
	...
	public Biome refrenceBiome() {
		...
		return WorldRegister.mazeReferenceBiome;
	}
	@Override
	...
	public OreEntry[] layerOres() {
		return new OreEntry[] {new OreEntry(Blocks.LAVA.getDefaultState(), 15, 5, 10)};
	}
	/*@Override
