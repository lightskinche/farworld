package net.lightskin.farworld.world.underground.generators.squeeze;
...
public class SqueezeRavineGenerator implements IFlexHandlerStructureGenerator{
	  /**
     * Vanilla value: 50
     * <p>
     ...
     */
    private static final double RAVINE_SIZE_ADD = 3.5D;
    ...
    public SqueezeRavineGenerator(CustomGeneratorSettings cfg) {
