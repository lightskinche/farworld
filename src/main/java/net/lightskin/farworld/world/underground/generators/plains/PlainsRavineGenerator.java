package net.lightskin.farworld.world.underground.generators.plains;
...
public class PlainsRavineGenerator implements IFlexHandlerStructureGenerator{
	  /**
     * Vanilla value: 50
     * <p>
     * Multiply by 16 and divide by 8: 16 cubes in vanilla chunks, only one in 8 cubes has structures generated
     */
    private static final int RAVINE_RARITY = 5000 * 16 / (2 * 2 * 2);
     ...
     */
    private static final double LAVA_HEIGHT_OFFSET = -100000;
     ...
     */
    private static final double RAVINE_SIZE_ADD = 5.5D;
    ...
    public PlainsRavineGenerator(CustomGeneratorSettings cfg) {
